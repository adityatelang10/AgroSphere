...
export default function DecisionEngineSection() {
  return <section id="decision-engine" className="lp-section lp-decision">
    ...
    <div className="lp-evidence-map" data-decision-map aria-label="Relevant evidence connects to the AgroSphere Decision Engine">
      <svg className="lp-evidence-lines" viewBox="0 0 1000 400" preserveAspectRatio="none" fill="none" aria-hidden="true"><g><path pathLength="1" d="M150 60H320Q365 60 365 115V155Q365 200 500 200" /><path pathLength="1" d="M150 200H500" /><path pathLength="1" d="M150 340H320Q365 340 365 285V245Q365 200 500 200" /><path pathLength="1" d="M850 60H680Q635 60 635 115V155Q635 200 500 200" /><path pathLength="1" d="M850 200H500" /><path pathLength="1" d="M850 340H680Q635 340 635 285V245Q635 200 500 200" /><path pathLength="1" d="M500 200V400" /></g></svg>
      <div className="lp-evidence-column"><div data-evidence><small>01 / PLANNING</small><strong>Crop recommendation</strong></div><div data-evidence><small>02 / PLANT HEALTH</small><strong>Disease evidence</strong></div><div data-evidence><small>03 / WATER</small><strong>Irrigation evidence</strong></div></div>
      ...
      <div className="lp-evidence-column"><div data-evidence><small>04 / CURRENT CROP</small><strong>Inventory</strong></div><div data-evidence><small>05 / REPORTED DATA</small><strong>Market evidence</strong></div><div data-evidence><small>06 / REAL CONSTRAINTS</small><strong>Farmer context</strong></div></div>
    </div>
    <div className="lp-next-action"><div><SampleLabel>Illustrative Tomato decision</SampleLabel><h3>Plan irrigation soon.</h3><span className="lp-action-code">IRRIGATE_SOON</span></div><div className="lp-priority"><small>PRIORITY SCORE</small><strong><span data-count="100">100</span><span> / 100</span></strong><p>Deterministic ranking.<br />Not probability or confidence.</p></div></div>
